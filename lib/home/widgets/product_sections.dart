...
import 'package:levantsale/category/category_listings_screen.dart';
...
class _ProductSectionsState extends State<ProductSections> {
          ...
          children: [
            for (final section in sections) ...[
              Padding(
                ...
                child: _header(context, section.title, section.id),
              ),
  ...
  Widget _gridFor(List<Listing> products) {
    ...
    return SizedBox(
      height: 260, // Increased from 240 to accommodate verified badge
