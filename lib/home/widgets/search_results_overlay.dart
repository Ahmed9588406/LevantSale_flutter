...
class _SearchResultsOverlayState extends State<SearchResultsOverlay> {
  ...
  Widget _buildContent() {
    ...
    // Show limited results (max 5) with "View All" button
    final displayResults = _searchResults.take(5).toList();
    final hasMore = _searchResults.length > 5;
        ...
        Flexible(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              final listing = displayResults[index];
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          SearchResultsScreen(searchQuery: widget.searchQuery),
                    ),
                  );
                },
