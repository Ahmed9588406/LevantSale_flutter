...
class Listing {
  ...
  final bool isVerified; // Seller verification status
  ...
  factory Listing.fromJson(Map<String, dynamic> json) {
    ...
    return Listing(
      ...
      isVerified: json['isVerified'] == true || json['userVerified'] == true,
      attributes: attrs,
    );
  }
}
...
class HomeService {
  ...
  static Future<List<dynamic>?> fetchCategoryAttributes(
    String categoryId,
  ) async {
    ...
    if (res.statusCode >= 200 && res.statusCode < 300) {
      ...
      throw Exception(
        'Failed to fetch category attributes (${res.statusCode})',
      );
    }
  }
}
