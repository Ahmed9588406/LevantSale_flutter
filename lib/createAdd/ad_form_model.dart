...
/// Model representing a city from the backend
class CityModel {
  final String id;
  final String name;
...
class AdFormData {
  ...
  String? price;
  String? currencyId; // Currency ID (UUID) instead of code
  String? location;
  String? phone;
  String condition = 'USED';
  String? cityId; // City ID for location
  ...
  Map<String, dynamic> toJson() {
    ...
    return {
      ...
      'currencyId': currencyId ?? '', // Send currency ID
      'location': location?.trim() ?? '',
      'phone': phone?.trim() ?? '',
      'condition': condition,
      'cityId': cityId ?? '', // Include cityId in the JSON
  ...
  void reset() {
    ...
    subcategoryId = null;
    price = null;
    currencyId = null; // Reset currency ID
    location = null;
    phone = null;
    condition = 'USED';
    cityId = null; // Reset cityId
    images = <File>[];
...
class AdFormDraft {
  ...
  List<CityModel> cities = []; // Add cities list
