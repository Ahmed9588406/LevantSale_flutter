...
class _Step2LocationConditionState extends State<Step2LocationCondition> {
  ...
  bool get _isValid {
    return _draft.formData.cityId != null &&
        _draft.formData.cityId!.isNotEmpty &&
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          // City Selection
          _buildLabel('المدينة', required: true),
          const SizedBox(height: 8),
          GestureDetector(
            onTap: () {
              setState(() => _showCityDropdown = !_showCityDropdown);
            },
            child: Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(
                      _getSelectedCityName(),
                      textAlign: TextAlign.right,
                      style: TextStyle(
                        fontSize: 16,
                        color:
                            _draft.formData.cityId != null &&
                                _draft.formData.cityId!.isNotEmpty
                            ? Colors.black87
                            : Colors.grey[400],
                      ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  // Cities list
                  ..._draft.cities.map((city) {
                    return InkWell(
                      onTap: () {
                        setState(() {
                          _draft.formData.cityId = city.id;
                          _showCityDropdown = false;
                        });
                      },
                      child: Container(
          ...
          _buildLabel('تفاصيل الموقع (اختياري)'),
          const SizedBox(height: 8),
          _buildTextField(
            controller: _locationController,
            hint: 'مثال: حي، شارع، رقم المبنى',
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton<String>(
                          value: _draft.formData.currencyId,
                          isExpanded: true,
                          isDense: true,
                          ...
                          onChanged: (value) {
                            if (value != null) {
                              setState(() {
                                _draft.formData.currencyId = value;
                              });
                            }
                          },
                        ),
  ...
  String _getSelectedCityName() {
    if (_draft.formData.cityId == null || _draft.formData.cityId!.isEmpty) {
      return 'اختر المدينة';
    }

    final selectedCity = _draft.cities.firstWhere(
      (city) => city.id == _draft.formData.cityId,
      orElse: () => CityModel(
        id: '',
        name: 'غير محدد',
        country: '',
